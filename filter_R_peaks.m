function [c_pks_cln, c_locs_cln, out_pks, out_len_unilenght] = filter_R_peaks(c_pks, c_locs, RR_window, data)
% FILTER_R_PEAKS 
...
%   1.
    ...
    [~, out_pks] = rmoutliers(c_pks, 'movmedian', RR_window);
    [~, out_len] = rmoutliers(diff(c_locs),'movmedian', RR_window);
    ...
    plot(c_locs(out_len_unilenght), c_pks(out_len_unilenght),'bo','MarkerSize',40)
    axis tight
